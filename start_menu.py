...
def program_loop():
    ...
    while start_input not in ["R", "r", "L", "l"]:
        start_input = input('Skriv "L" for å logge inn, eller "R" for å registrere bruker: \n');
        
    if start_input == "R" or start_input == "r":
        #Gå til registrering
        kunde = makeKunde(cursor, input("Skriv inn navn: "), input("Skriv inn adresse: "), input("Skriv inn telefonnummer: "))
        ...
        while True:
            kunde_input = input("For å logge inn, skriv: 'KUNDENUMMER og NAVN': \n")
